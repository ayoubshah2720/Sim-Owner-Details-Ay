...
export default function SimCheckScreen({ navigation, route, onMenuPress }) {
  const payload = route?.params?.payload;
  const cnicNotice = route?.params?.cnicNotice;
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Sim Owner Detail</Text>
        <TouchableOpacity
      ...
      <ScrollView contentContainerStyle={styles.content}>
        {(cnicNotice?.message || results.length === 0) ? (
